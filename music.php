...
<head>
    ...
    <title>音乐商城 - BookMusic Mall</title>
        ...
        <div class="container">
            <div class="navbar-content">
                ...
                <ul class="navbar-nav">
                    ...
                    <li><a href="/music.php" class="active">音乐</a></li>
                </ul>
        ...
        <div class="container">
            ...
            <div class="filter-bar">
                <form method="GET" class="search-form">
                    <input type="text" name="search" placeholder="搜索歌曲名称或歌手..." 
            ...
            <?php if (empty($music)): ?>
                <div class="empty-state">
                    ...
                    <h3>暂无音乐</h3>
                    <p>没有找到符合条件的音乐，请尝试其他搜索条件</p>
                </div>
            <?php else: ?>
                <div class="products-grid">
                    <?php foreach ($music as $item): ?>
                        <div class="product-card" onclick="window.location.href='/product.php?id=<?= $item['id'] ?>'">
                            <img src="/uploads/cover/<?= e($item['cover']) ?>" alt="<?= e($item['title']) ?>" class="product-image">
                            <div class="product-info">
                                <span class="product-category"><?= e($item['category_name'] ?? '音乐') ?></span>
                                <h3 class="product-title"><?= e($item['title']) ?></h3>
                                <p class="product-author">歌手：<?= e($item['author']) ?></p>
